                ...
                <ResponsiveContainer width="100%" height="100%">
                  <ScatterChart margin={{ top:10, right:20, bottom:30, left:20 }}>
                    ...
                    <Tooltip contentStyle={{ background:'#111d35', border:'1px solid #1a2d50', borderRadius:8 }}
                      cursor={{ strokeDasharray: '3 3', stroke: 'rgba(0,245,255,0.3)' }}
      ...
      <div className="mt-4 h-56">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={chartData} margin={{ top:5, right:10, bottom:25, left:0 }}>
            ...
            <Bar dataKey="precision" name="Precision" fill="rgba(0,245,255,0.6)"   radius={[2,2,0,0]} isAnimationActive={false} />
            <Bar dataKey="recall"    name="Recall"    fill="rgba(124,58,237,0.6)"  radius={[2,2,0,0]} isAnimationActive={false} />
            <Bar dataKey="f1"        name="F1 Score"  fill="rgba(249,115,22,0.6)"  radius={[2,2,0,0]} isAnimationActive={false} />
          </BarChart>
        </ResponsiveContainer>
      </div>
