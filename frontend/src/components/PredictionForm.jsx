...
export default function PredictionForm({ deployment, onMetaUpdate }) {
  ...
  // CSV upload for label enrichment
  const onCsvDrop = useCallback(async (files) => {
    ...
    try {
      ...
      // Update parent metadata with new schema
  ...
  return (
    <div className="space-y-5">
      ...
      {/* CSV enrichment banner — only show if there are encoded dropdowns and not yet enriched */}
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-yellow-700 font-mono text-xs mb-3">
                Upload your original training CSV to replace 0, 1, 2... with real labels like "Apple", "macOS"
              </p>
  ...
  return (
    <div className="space-y-1.5">
      ...
      {field.widget === 'toggle' ? (
        ...
        // Numeric encoded — show Category 0, 1, 2 with hint to upload CSV
        <div className="space-y-1">
          ...
          <div className="text-slate-700 text-xs font-mono flex items-center gap-1">
            <span>⚠️</span><span>Upload CSV above to see real labels</span>
          </div>
        </div>
